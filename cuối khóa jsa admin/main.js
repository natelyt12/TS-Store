...
console.log(parsedProducts);
  ...
  for(let i of parsedProducts.data){
        ...
        let firm=document.createElement("h4")
        firm.innerText=i.firm
        product_img.appendChild(firm)
  
        let price=document.createElement("h4")
        price.innerText=i.price
        product_img.appendChild(price)
  
        document.getElementById("products").appendChild(product_info)
  }
...
//       var ID = document.getElementById("idhello").value;
//       var password = document.getElementById("password").value;
...
//       }
//       else if(ID == data.ID && password == data.password){
...
// var form = document.getElementById("product-widget");
...
//   var productBrand = productBrandInput.value;
//   var productPrice = productPriceInput.value;
//   var productImage = productImageInput.value;

//   // Tạo một đối tượng mới đại diện cho sản phẩm
//   var list_products = localStorage.getItem('products');
//   var list = JSON.parse(list_products)
//   var newProduct = {
...
//   // Thêm sản phẩm vào mảng data trong đối tượng products
//   list.data.push(newProduct);
...
//   console.log(products); // Hiển thị đối tượng products sau khi thêm sản phẩm
